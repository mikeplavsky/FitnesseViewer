...
fitnesse.viewer.scenarios = function(opt_data, opt_sb) {
  ...
  output.append('<div id="fv-header"><div class="fv-view" id="fv-view-all">All Scenarios: ', soy.$$escapeHtml(opt_data.all_scenarios), '</div><div class="fv-view" id="fv-view-used">Used Scenarios: ', soy.$$escapeHtml(opt_data.scenarios), '</div><div class="fv-view" id="fv-view-funcs">Used Functions: ', soy.$$escapeHtml(opt_data.functions), '</div><div class="fv-view" id="fv-view-unused">Unused Scenarios: ', soy.$$escapeHtml(opt_data.unused_scenarios), '</div></div><div id="fv-scenarios-list">');
